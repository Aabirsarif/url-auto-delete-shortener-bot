...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            [
                InlineKeyboardButton('Join Mr Movie Premium', url='https://t.me/+AI5hTeDMyZ5kOTJl'),
            ],
            [
                InlineKeyboardButton('Movie request', url=f'https://t.me/+Uui2XqOurDI5OTM1')
            ],
            [
    ...
    if len(message.command) != 2:
        buttons = [[
             InlineKeyboardButton('Add Mr Movie in your group', url=f'http://t.me/{temp.U_NAME}?startgroup=true'),
            ],[
            InlineKeyboardButton('Mr Movie Premium', url='https://t.me/+AI5hTeDMyZ5kOTJl'),
            InlineKeyboardButton('Movie request', url='https://t.me/+Uui2XqOurDI5OTM1'),
            ],[
            InlineKeyboardButton('sᴜᴘᴘᴏʀᴛ', url='https://t.me/+TnIzgqwIxYgzYWFl'),
            InlineKeyboardButton('Issues?', url='https://t.me/+TnIzgqwIxYgzYWFl'),
            ],[
            InlineKeyboardButton('👋 Other 👋', callback_data='about'),
            ],[
